                                    ...
                                    <div class="card-body">
                                        <form action="<?=base_url('home/aksi_tbarang')?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-name" name="kbarang" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
