                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form method="GET" action="<?= base_url('home/filtertanggalbm') ?>">
                            <div class="row mb-3">
                                <div class="col-md-3">
...
function generatePDF() {
    ...
    var url = '<?= base_url('home/barangm_pdf') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
...
function generateEXCEL() {
    ...
    // Build the URL for the PDF
    var url = '<?= base_url('home/barangm_excel') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
...
function generateWINDOWS() {
    ...
    // Build the URL for the PDF
    var url = '<?= base_url('home/barangm_windows') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
