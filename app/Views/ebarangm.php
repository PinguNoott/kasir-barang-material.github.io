...
<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <form action="<?=base_url('home/aksi_ebarangm')?>" method="post" novalidate="novalidate">
                                ...
                                <?php endforeach; ?>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="stok" type="number" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" value="<?=$satu->quantity?>">
                                            ...
                                            <div>
                                                ...
                                                <input type="hidden" name="id" value="<?=$satu->id_bmasuk?>">
